...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            with open(r"en.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"en1.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"classifiermodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'classifierscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"classifierencode.pkl", 'rb') as f:
